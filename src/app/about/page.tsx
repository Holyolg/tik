    ...
    <main className="container mx-auto mt-14 md:mt-32">
      <div className="flex flex-wrap justify-between items-center">
        ...
        <a
          ...
          <div className="w-5 self-center">
            <Image width={400} height={135} src="/download.svg" alt="download" sizes="400px" />
          </div>
        </a>
      </div>
      <div className="w-full h-full flex flex-col-reverse lg:flex-row justify-between mt-12">
        <div className="flex flex-col justify-between max-w-xl xl:max-w-3xl">
          <p className=" text-gray-500 leading-relaxed mt-10 lg:mt-0">
            ТИК-ПРОДЖЕКТ - команда архитекторов, конструкторов, инженеров и ТИМ-специалистов. <br />{" "}
            В аббревиатуре «TIK»: «Technologies Innovations Knowledge» заложены основные принципы и
            ценности компании, которым мы следуем с 2017 года. <br /> Применение современных
            технологий, креативность и энергичность молодых специалистов, знания и опыт старших
            коллег - такой симбиоз позволяет нам создавать уникальный продукт, задающий новые
            стандарты качества и удовлетворяющий всем потребностям наших заказчиков. <br />
            Основной вид деятельности компании - оказание услуг генпроектирования. Мы проектируем
            жилые и многофункциональные комплексы, офисные здания и торговые центры, социальные
            объекты, а также занимаемся разработкой архитектурных концепций, интерьеров и комфортной
            городской среды.
          </p>
        </div>
        <div className="">
          <Image width={500} height={158} src="/logo.svg" alt="logo" sizes="400px" />
        </div>
      </div>
      <div className="flex flex-wrap justify-between mt-12  text-gray-800 gap-10 xl:gap-0">
        <div className="w-full lg:w-52 2xl:w-64 h-40 p-3 rounded-xl flex flex-col justify-between bg-gray-100">
          ...
          <span className=" lg:text-sm">Выполнено проектов</span>
        </div>

        <div className="w-full lg:w-52 2xl:w-64 h-40 p-3 rounded-xl flex flex-col justify-between bg-gray-100 ">
          <b className="text-xl">&gt;20</b>
          <span className=" lg:text-sm">АХО, АГО и АГР</span>
        </div>
        <div className="w-full lg:w-52 2xl:w-64 h-40 p-3 rounded-xl flex flex-col justify-between bg-gray-100 ">
          <b className="text-xl"> &gt;80</b>
          <span className=" lg:text-sm">Специалистов в штате</span>
        </div>
        <div className="w-full lg:w-52 h-40 p-3 rounded-xl flex flex-col justify-between bg-gray-100">
          <b className="text-xl">
            Допуск СРО <br /> &gt;300 млн. руб
          </b>
          <span className=" lg:text-sm">Допуск к проектированию опасных и уникальных объектов</span>
        </div>
        <div className="w-full lg:w-52 2xl:w-64 h-40 p-3 rounded-xl flex flex-col justify-between bg-gray-100">
          <b className="text-xl">Технологии информационного моделирования (ТИМ), ЦИМ</b>
          <span className=" lg:text-sm">Все проекты и все стадии</span>
        </div>
        <div className="w-full lg:w-52 2xl:w-64 h-40 p-3 rounded-xl flex flex-col justify-between bg-gray-100">
          <b className="text-xl">Ассоциация проектировщиков Московской области</b>
          <span className=" lg:text-sm">Членство с 2022 года</span>
        </div>
      </div>
        ...
        <div className="mt-6 leading-relaxed  lg:text-sm xl:text-base">
          ...
          <div className="mt-6 flex flex-col-reverse md:flex-row w-full h-full justify-between gap-4 text-gray-500">
            <div className="max-w-2xl xl:max-w-3xl">
              <span>
                Мы предоставляем полный спектр услуг в области генпроектирования, гарантируя высокое
                качество, соответствие нормативным требованиям и оперативность выполнения работ.
              </span>
              <div>
                <br />
                ...
                <ul className="ml-4">
                  ...
                  <li>• Подготовка ЦИМ-модели в соответствии с актуальными требованиями.</li>
                </ul>
                ...
                <ul className="ml-4">
                  ...
                  <li>
                    • Согласование с ресурсоснабжающими организациями (МОЭК, Мосводоканал,
                    Мосводосток и д.р.).
                  </li>
                  <li>• Подготовка ЦИМ-модели в соответствии с актуальными требованиями.</li>
                </ul>
                ...
                <ul className="ml-4">
                  <li>• Контроль за ходом строительства и соблюдением проектных решений.</li>
                  <li>• Консультации и внесение корректировок в процессе строительства.</li>
                </ul>
              </div>
              <br />
            </div>
          ...
          <div className="mt-6 flex flex-col md:flex-row w-full h-full justify-between gap-4 text-gray-500">
            ...
            <div className="max-w-2xl xl:max-w-3xl">
              <span>
                Наша компания предлагает комплексный подход к разработке архитектурных концепций,
                учитывая все аспекты — от эстетики до практичности и соответствия требованиям и
                ожиданиям заказчика.
              </span>
              <div>
                Мы разрабатываем:
                ...
                <ul className="ml-4">
                  ...
                  <li>• Исследование функциональных потребностей и предпочтений заказчика.</li>
                </ul>
                ...
                <ul className="ml-4">
                  ...
                  <li>• Предложение различных вариантов планировок и фасадных решений.</li>
                ...
                <ul className="ml-4">
                  ...
                  <li>
                    • Разработка предварительных инженерных решений (отопление, вентиляция,
                    водоснабжение, электроснабжение и др.).
                  </li>
                </ul>
