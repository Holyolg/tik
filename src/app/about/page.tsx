        ...
        <div className="mt-6">
          ...
          <div className="mt-6 flex flex-col-reverse md:flex-row w-full h-full justify-between gap-10">
            <div className="max-w-2xl text-sm">
              ...
              <ul>
                <li>
                  • Опыт и профессионализм: Команда высококвалифицированных
                  специалистов с многолетним опытом в области проектирования и
                  строительства.
                </li>
                <li>
                  • Комплексный подход: Мы берем на себя все этапы
                  проектирования, от идеи до реализации, что позволяет
                  минимизировать риски и ускорить процесс строительства.
                </li>
                <li>
                  • Современные технологии: Использование передового
                  программного обеспечения и современных методов проектирования
                  для достижения наилучших результатов.
                </li>
                <li>
                  • Индивидуальный подход: Учёт всех пожеланий и требований
                  заказчика, обеспечение уникальных решений для каждого проекта.
                  Обращаясь к нам, вы получаете надежного партнера, который
                  возьмет на себя все заботы по генпроектированию и обеспечит
                  качественное выполнение работ на каждом этапе.
                </li>
              </ul>
            </div>
